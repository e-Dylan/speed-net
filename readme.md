...
`python SNet.py --mode=make_data --video_file=driving_file.mp4 --speeds_file=speed_file.txt`
...
`python SNet.py --mode=test --model_file=model_file_name.pth --video_file=test.mp4 --speeds_file=test_speeds.txt`
